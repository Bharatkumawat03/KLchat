...
const Requests = () => {
  ...
  return (
    <div className="">
      ...
      <p className="mt-5  text-center">
        {data?.data == "" ? "no requests available" : ""}
      </p>
            ...
            <div key={i} className="flex ">
              <li className="list-row  flex gap-2 m-2 md:px-10 bg-base-200 p-4 mx-auto rounded-lg w-full md:w-2/3 lg:w-1/2 justify-between">
                ...
                <div className="">
                  <button
                    onClick={() => {
                      mutation.mutate({ request, status: "accepted" });
                    }}
                    // onClick={() => {handleRequest(request,"accepted")}}
                    className="rounded-full p-3  bg-primary text-base-100 btn-ghost mx-2 md:mx-4"
                  >
                    <SiTicktick />
                  </button>
                  <button
                    ...
                    onClick={() => {
                      mutation.mutate({ request, status: "rejected" });
                    }}
                    className="rounded-full p-3 bg-secondary text-base-100 btn-ghost"
                  >
                    <RxCross1 />
                  </button>
                </div>
